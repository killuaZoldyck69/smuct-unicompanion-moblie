...
export default function BloodThreadScreen() {
    ...
    <View style={styles.originalPostContainer}>
      ...
      <View style={styles.authorSection}>
        ...
        <TouchableOpacity
          ...
          accessibilityLabel={`View requester profile for ${post.author?.name}`}
        >
          {post.author?.image ? (
            <Image
  ...
  const renderReply = ({ item }: { item: any }) => (
    <TouchableOpacity
      ...
      accessible={true}
      accessibilityRole="button"
      accessibilityLabel={`Volunteer: ${item.responder?.name}, Phone: ${item.responder?.phoneNumber || "Not provided"}`}
    >
