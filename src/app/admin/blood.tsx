...
export default function AdminBloodManageScreen() {
  ...
  const handleActionExecute = () => {
    ...
    if (actionData.type === "RESOLVE") {
      resolveMutation.mutate(actionData.id, {
        onSuccess: () => {
      ...
      deleteMutation.mutate(actionData.id, {
        onSuccess: () => {
          ...
          <View style={styles.actionButtonsRight}>
            {!item.isFulfilled && (
              <TouchableOpacity
                ...
                accessible={true}
                accessibilityRole="button"
                accessibilityLabel={`Resolve blood request for ${item.patientName}`}
              >
                <Feather
                  name="check"
                  size={14}
            ...
            <TouchableOpacity
              ...
              accessible={true}
              accessibilityRole="button"
              accessibilityLabel={`Delete blood request for ${item.patientName}`}
            >
      ...
      <View style={styles.searchContainerWrapper}>
        <View style={styles.searchContainer}>
          ...
          <TextInput
            ...
            accessible={true}
            accessibilityLabel="Search by patient, condition, or author"
          />
        </View>
      </View>
      ...
      <View style={styles.tabsContainer}>
        {["ALL", "URGENT", "FULFILLED"].map((filter) => (
          <TouchableOpacity
            ...
            accessibilityLabel={`${filter} blood requests filter`}
          >
            <Text
              style={[
                styles.tabText,
