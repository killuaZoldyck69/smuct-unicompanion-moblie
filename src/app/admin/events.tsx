...
export default function AdminEventsManageScreen() {
  ...
  const createMutation = useCreateCampusEvent();
  const deleteMutation = useDeleteCampusEvent();
  ...
  const handleAddEvent = async () => {
    ...
    const payload = {
      ...
      location: formData.location.trim() || "SMUCT Campus",
      organizer: "SMUCT Administration",
      eventDate: isoDate,
    };
