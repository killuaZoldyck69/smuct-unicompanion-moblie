...
export default function AdminFieldBookingScreen() {
  ...
  const { data: bookings, isLoading: isLoadingBookings } = useAllFieldBookingsAdmin();
  const { data: settings, isLoading: isLoadingSettings } = useFieldSettings();

  // Populate settings form when settings load
  useEffect(() => {
    if (settings) {
      setSettingsForm({
        isBookingOpen: settings.isBookingOpen ?? true,
        closedNotice: (settings as any).closedNotice || settings.closureReason || "",
      });
    }
  }, [settings]);
  ...
  const updateStatusMutation = useMutation({
    ...
    }) => useUpdateFieldBookingStatus(id).mutateAsync({ status }),
  ...
  const updateSettingsMutation = useMutation({
    mutationFn: (payload: typeof settingsForm) =>
      useUpdateFieldSettings().mutateAsync({
        ...
        {item.status === "PENDING" && (
          <View style={styles.actionGroup}>
            <TouchableOpacity
              ...
              accessibilityLabel={`Reject booking request for ${item.purpose}`}
            >
              <Feather
                name="x"
                size={14}
            ...
            <TouchableOpacity
              ...
              accessible={true}
              accessibilityRole="button"
              accessibilityLabel={`Approve booking request for ${item.purpose}`}
            >
              <Feather
                name="check"
                size={14}
    ...
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          accessible={true}
          accessibilityRole="button"
          accessibilityLabel="Open global field settings"
        >
      ...
      <View style={styles.tabsContainer}>
        {["ALL", "PENDING", "APPROVED", "REJECTED"].map((filter) => (
          <TouchableOpacity
            ...
            accessibilityLabel={`${filter} requests filter`}
          >
            <Text
              style={[
                styles.tabText,
            ...
            <View style={styles.fullModalContent}>
              <View style={styles.switchRow}>
                ...
                <Switch
                  ...
                  thumbColor="#FFF"
                  accessibilityLabel="Enable Field Bookings"
                />
              </View>
              ...
              {!settingsForm.isBookingOpen && (
                <View style={styles.noticeInputBox}>
                  ...
                  <TextInput
                    ...
                    accessible={true}
                    accessibilityLabel="Closure Notice Message"
                  />
                </View>
              )}
            </View>
