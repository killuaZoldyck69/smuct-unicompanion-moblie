...
export default function AdminAlumniScreen() {
  ...
  const { data: alumniList, isLoading } = useAlumniList();
    ...
    <View style={styles.card}>
      ...
      <View style={styles.actionRow}>
        <TouchableOpacity
          ...
          accessibilityLabel={`Edit alumni details for ${item.name}`}
        >
        ...
        <TouchableOpacity
          ...
          accessible={true}
          accessibilityRole="button"
          accessibilityLabel={`Delete alumni record for ${item.name}`}
        >
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topActions}>
        <TouchableOpacity
          ...
          accessible={true}
          accessibilityRole="button"
          accessibilityLabel="Add Single Alumni"
        >
          <Feather
            name="user-plus"
            size={16}
        ...
        <TouchableOpacity
          ...
          accessible={true}
          accessibilityRole="button"
          accessibilityLabel="Bulk Upload Alumni JSON"
        >
          <Feather
            name="upload-cloud"
            size={16}
      ...
      <View style={styles.searchContainerWrapper}>
        <View style={styles.searchContainer}>
          ...
          <TextInput
            ...
            accessible={true}
            accessibilityLabel="Search alumni by name, batch, department"
          />
        </View>
      </View>
        ...
        >
          ...
          >
            <View style={styles.modalHeader}>
              <TouchableOpacity
                onPress={closeSingleModal}
                accessible={true}
                accessibilityRole="button"
                accessibilityLabel="Cancel editing alumni"
              >
              ...
              <TouchableOpacity
                ...
                accessible={true}
                accessibilityRole="button"
                accessibilityLabel="Save alumni"
              >
            ...
            <ScrollView contentContainerStyle={styles.modalContent}>
              ...
              <TextInput
                ...
                placeholder="Google"
                accessible={true}
                accessibilityLabel="Current Company"
              />
              ...
              <TextInput
                ...
                accessible={true}
                accessibilityLabel="Job Title or Position"
              />
          ...
          >
            <View style={styles.modalHeader}>
              <TouchableOpacity
                ...
                accessible={true}
                accessibilityRole="button"
                accessibilityLabel="Cancel bulk upload"
              >
                <Text style={styles.cancelText}>Cancel</Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                accessible={true}
                accessibilityRole="button"
                accessibilityLabel="Upload bulk JSON"
              >
            ...
            <View style={styles.modalContent}>
              ...
              <TextInput
                ...
                autoCorrect={false}
                accessible={true}
                accessibilityLabel="Alumni JSON array payload"
              />
            </View>
          </KeyboardAvoidingView>
        </SafeAreaView>
