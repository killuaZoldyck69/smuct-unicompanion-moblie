...
import { useCreateNotice } from "@/features/notices/useNotices";
...
export default function AdminNoticeUploadScreen() {
  ...
  // Publish Mutation using Feature Hook
  const publishMutation = useCreateNotice();
    ...
    >
      ...
      >
          ...
          <View style={styles.ccInputContainer}>
            ...
            >
              <TextInput
                ...
                accessible={true}
                accessibilityLabel="Copy to (CC) recipient"
              />
            </View>
            <TouchableOpacity
              ...
              accessible={true}
              accessibilityRole="button"
              accessibilityLabel="Add recipient to CC"
            >
              ...
              {formData.copyTo.map((item, index) => (
                <View key={index} style={styles.ccChip}>
                  ...
                  <TouchableOpacity
                    ...
                    accessible={true}
                    accessibilityRole="button"
                    accessibilityLabel={`Remove ${item} from CC`}
                  >
        ...
        <TouchableOpacity
          ...
          accessible={true}
          accessibilityRole="button"
          accessibilityLabel="Publish Official Notice"
        >
