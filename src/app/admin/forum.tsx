        ...
        <View style={styles.actionRow}>
          {!item.isResolved && (
            <TouchableOpacity
              ...
              accessibilityLabel={`Resolve forum post: ${item.title}`}
            >
              <Feather
                name="check"
                size={14}
          ...
          <TouchableOpacity
            ...
            accessible={true}
            accessibilityRole="button"
            accessibilityLabel={`Delete forum post: ${item.title}`}
          >
            <Feather
              name="trash-2"
              size={14}
      ...
      <View style={styles.searchContainerWrapper}>
        <View style={styles.searchContainer}>
          ...
          <TextInput
            ...
            accessible={true}
            accessibilityLabel="Search discussions by title or author"
          />
        </View>
      </View>
      ...
      <View style={styles.tabsContainer}>
        {["ALL", "UNRESOLVED", "RESOLVED"].map((filter) => (
          <TouchableOpacity
            ...
            accessibilityLabel={`${filter} forum posts filter`}
          >
            <Text
              style={[
                styles.tabText,
