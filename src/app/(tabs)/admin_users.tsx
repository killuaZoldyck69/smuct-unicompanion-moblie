...
export default function AdminManageUsersScreen() {
  ...
  const { role, isPending, isAuthenticated } = useCurrentUser();

  useEffect(() => {
    if (!isPending && (!isAuthenticated || role !== "ADMIN")) {
      router.replace("/(tabs)");
    }
  ...
  const renderUserCard = ({ item }: { item: any }) => {
    ...
    return (
      <TouchableOpacity
        ...
        accessibilityLabel={`User: ${item.name}, ${profile?.department || "No Dept"}, ${item.role}`}
      >
        {/* Avatar Handle */}
        {item.image ? (
          <Image
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.searchContainer}>
          ...
          <TextInput
            ...
            accessible={true}
            accessibilityLabel="Search by name, ID, or email"
          />
      ...
      <View style={styles.tabsContainer}>
        <TouchableOpacity
          ...
          accessibilityLabel="Students directory tab"
        >
          <Text
            style={[
              styles.tabText,
        ...
        <TouchableOpacity
          ...
          accessible={true}
          accessibilityRole="tab"
          accessibilityLabel="Teachers directory tab"
        >
          <Text
            style={[
              styles.tabText,
              ...
              <View style={styles.modalProfileHeader}>
                {selectedUser.image ? (
                  <Image
                    ...
                    accessible={true}
                    accessibilityLabel={`${selectedUser.name}'s profile photo`}
                  />
                ) : (
