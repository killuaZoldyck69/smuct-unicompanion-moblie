...
export default function MyScheduleScreen() {
  ...
  // Fetch my joined hubs using Feature Hook
  const {
    data: myHubs,
    isLoading,
    isError,
    ...
    return (
      <View style={styles.sectionHeaderBox}>
        <Text
          style={[
            styles.sectionTitle,
            isToday && { color: colors.primaryContainer },
          ]}
        >
          {title} {isToday && " (Today)"}
        </Text>
    ...
    <SafeAreaView style={styles.container} edges={["top"]}>
      ...
      {isLoading ? (
        ...
        <View style={styles.centerContainer}>
          ...
          />
          <Text style={styles.emptyTitle}>Failed to Load Schedule</Text>
          <Text style={styles.emptyDesc}>
            An error occurred while fetching your class routines.
          </Text>
          <TouchableOpacity
