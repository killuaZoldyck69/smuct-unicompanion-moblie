...
import { useTeachersDirectory } from "@/features/schedule/useSchedule";
  ...
  const renderTeacherCard = ({ item }: { item: any }) => {
    ...
    return (
      <TouchableOpacity
        ...
        accessibilityLabel={`Teacher: ${item.name}, ${profile?.designation || "Faculty Member"}, ${profile?.department || "No Department"}`}
      >
        {item.image ? (
          <Image
    ...
    <View style={styles.container}>
      ...
      <View style={styles.searchContainerWrapper}>
        <View style={styles.searchContainer}>
          ...
          <TextInput
            ...
            accessible={true}
            accessibilityLabel="Search faculty by name, ID, or email"
          />
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                ...
                accessibilityLabel={`${item} department filter`}
              >
                <Text
                  style={[
                    styles.filterText,
      ...
      {isLoading ? (
        ...
        <View style={styles.centerContainer}>
          ...
          />
          <Text style={styles.emptyTitle}>Failed to Load Faculty</Text>
          <Text style={styles.emptyDesc}>
            An error occurred while fetching the faculty directory.
          </Text>
          <TouchableOpacity
            ...
            accessible={true}
            accessibilityRole="button"
            accessibilityLabel="Retry loading faculty"
          >
            <Feather
              name="refresh-cw"
              size={16}
        ...
        >
          <View style={styles.modalHeader}>
            ...
            <TouchableOpacity
              ...
              accessible={true}
              accessibilityRole="button"
              accessibilityLabel="Close teacher profile"
            >
