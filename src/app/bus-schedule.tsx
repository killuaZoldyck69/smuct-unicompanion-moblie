  ...
  return (
    <View style={styles.card}>
      ...
      <TouchableOpacity
        ...
        accessibilityLabel={`Bus Route: ${item.route}, Departure Time: ${item.departureTime}`}
      >
      ...
      {hasStops && (
        <TouchableOpacity
          ...
          accessible={true}
          accessibilityRole="button"
          accessibilityLabel={isExpanded ? "Hide route stops" : "View route stops"}
        >
...
export default function BusScheduleScreen() {
  ...
  // Fetch Bus Schedules using Feature Hook
  const {
    data: schedules,
    isLoading,
    isError,
      ...
      <View style={styles.header}>
        ...
        {userRole === "ADMIN" && (
          <TouchableOpacity
            ...
            accessible={true}
            accessibilityRole="button"
            accessibilityLabel="Manage bus schedule"
          >
