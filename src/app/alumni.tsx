  ...
  const renderAlumniCard = ({ item }: { item: any }) => {
    return (
      <TouchableOpacity
        ...
        accessibilityLabel={`Alumni: ${item.name}, ${item.currentPosition || "Professional"} ${item.currentCompany ? "at " + item.currentCompany : ""}, Batch ${item.batch || "N/A"}`}
      >
        {item.image ? (
          <Image
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <TouchableOpacity
                ...
                accessibilityLabel={`${item} department alumni filter`}
              >
                <Text
                  style={[
                    styles.filterText,
      ...
      {isLoading ? (
        ...
        <View style={styles.centerContainer}>
          ...
          <Text style={styles.emptyDesc}>
            An error occurred while fetching the alumni directory.
          </Text>
          <TouchableOpacity
