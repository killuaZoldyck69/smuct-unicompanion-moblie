  ...
  const renderReviewCard = ({ item }: { item: any }) => {
    ...
    return (
      <TouchableOpacity
        ...
        accessible={true}
        accessibilityRole="button"
        accessibilityLabel={`Review by ${reviewerName}, rating ${item.rating} stars`}
      >
      ...
      <View style={styles.header}>
        ...
        {canManage && (
          <TouchableOpacity
            ...
            accessible={true}
            accessibilityRole="button"
            accessibilityLabel="Open course review settings"
          >
            ...
            >
              <View style={styles.switchContainer}>
                ...
                <Switch
                  ...
                  thumbColor="#FFF"
                  accessibilityLabel="Accept Reviews"
                />
              </View>
              ...
              {settingsForm.reviewQuestions.map((q, index) => (
                <View key={index} style={styles.questionInputRow}>
                  ...
                  <TextInput
                    ...
                    accessible={true}
                    accessibilityLabel={`Feedback question ${index + 1}`}
                  />
                  <TouchableOpacity
                    ...
                    accessible={true}
                    accessibilityRole="button"
                    accessibilityLabel={`Delete feedback question ${index + 1}`}
                  >
              ...
              <TouchableOpacity
                ...
                accessible={true}
                accessibilityRole="button"
                accessibilityLabel="Add feedback question"
              >
                <Feather
                  name="plus"
                  size={16}
