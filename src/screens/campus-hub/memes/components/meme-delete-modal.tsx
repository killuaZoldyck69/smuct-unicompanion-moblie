...
interface MemeDeleteModalProps {
  visible: boolean;
  isDeleting: boolean;
  onConfirm: () => void;
  onClose: () => void;
...
export const MemeDeleteModal = React.memo(function MemeDeleteModal({
  visible,
  isDeleting,
  onConfirm,
  onClose,
}: MemeDeleteModalProps) {
        ...
        <View style={styles.backdrop}>
          <TouchableWithoutFeedback>
            ...
            >
              ...
              {/* Title & Description */}
              <Text style={styles.title}>Delete Meme?</Text>
              <Text style={styles.description}>
                This meme will be permanently removed from Campus Hub. This action cannot be undone.
              </Text>
              ...
              <View style={styles.buttonRow}>
                <TouchableOpacity
                  ...
                  accessibilityLabel="Cancel meme deletion"
                >
                ...
                <TouchableOpacity
                  ...
                  accessible={true}
                  accessibilityRole="button"
                  accessibilityLabel="Confirm delete meme"
                >
                  {isDeleting ? (
