  ...
  return (
    <>
      <TouchableOpacity
        ...
        accessibilityLabel={
          selectedTeacher
            ? `Selected instructor: ${selectedTeacher.name}`
          ...
          >
            ...
            <View style={styles.searchBox}>
              ...
              <TextInput
                ...
                autoFocus
                accessible={true}
                accessibilityLabel="Search instructors by name, department, or designation"
              />
            </View>
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <TouchableOpacity
                  ...
                  accessible={true}
                  accessibilityRole="button"
                  accessibilityLabel={`Select instructor ${item.name}, ${item.teacherProfile?.designation || "Faculty"} ${item.teacherProfile?.department || ""}`}
                >
