...
import { formatDateWithDay as formatDate, formatTime } from "@/utils/date-formatter";
import {
  useFieldSettings,
  useMyFieldBookings,
  useFieldSchedule,
...
export function FieldBooking() {
  ...
  const { data: myBookings, isLoading: isLoadingBookings } = useMyFieldBookings();
  const { data: publicSchedule, isLoading: isLoadingSchedule } = useFieldSchedule();
          ...
          >
            ...
            <View style={styles.modalContent}>
              ...
              <TextInput
                ...
                accessible={true}
                accessibilityLabel="Purpose or Event Name"
              />
              ...
              <TextInput
                ...
                maxLength={10}
                accessible={true}
                accessibilityLabel="Booking date in YYYY-MM-DD format"
              />
