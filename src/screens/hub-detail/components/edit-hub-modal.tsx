        ...
        >
          <View style={styles.modalHeader}>
            <TouchableOpacity
              ...
              accessibilityLabel="Cancel edit hub"
            >
          ...
          <ScrollView contentContainerStyle={styles.modalScrollContent}>
              ...
              <View key={schedule.id} style={styles.scheduleBlock}>
                ...
                <View style={styles.pickerContainer}>
                  <Picker
                    ...
                    accessibilityLabel={`Class ${index + 1} day of week`}
                  >
                    {DAYS.map((d) => (
                ...
                <View style={styles.rowInputs}>
                  <View style={{ flex: 1, marginRight: 8 }}>
                    ...
                    <TouchableOpacity
                      ...
                      accessible={true}
                      accessibilityRole="button"
                      accessibilityLabel={`Set class ${index + 1} start time`}
                    >
                  ...
                  <View style={{ flex: 1, marginLeft: 8 }}>
                    ...
                    <TouchableOpacity
                      ...
                      accessible={true}
                      accessibilityRole="button"
                      accessibilityLabel={`Set class ${index + 1} end time`}
                    >
                      <Text style={styles.timeBtnText}>
                ...
                <TextInput
                  ...
                  accessible={true}
                  accessibilityLabel={`Class ${index + 1} Room or Lab Number`}
                />
              </View>
            ))}
            <TouchableOpacity
              ...
              accessible={true}
              accessibilityRole="button"
              accessibilityLabel="Add Class Time"
            >
              <Feather
                name="plus-circle"
                size={16}
            ...
            <View style={styles.rowInputs}>
              <View style={{ flex: 1, marginRight: 8 }}>
                ...
                <TouchableOpacity
                  ...
                  accessible={true}
                  accessibilityRole="button"
                  accessibilityLabel="Set Midterm Exam Date"
                >
                  <Text style={styles.timeBtnText}>
                    {midtermDate
              ...
              <View style={{ flex: 1, marginLeft: 8 }}>
                ...
                <TouchableOpacity
                  ...
                  accessible={true}
                  accessibilityRole="button"
                  accessibilityLabel="Set Midterm Exam Time"
                >
                  <Text style={styles.timeBtnText}>
                    {midtermDate
            ...
            <TextInput
              ...
              placeholder="e.g. 402"
              accessible={true}
              accessibilityLabel="Midterm Exam Room Number"
            />
            ...
            <View style={styles.rowInputs}>
              <View style={{ flex: 1, marginRight: 8 }}>
                ...
                <TouchableOpacity
                  ...
                  accessible={true}
                  accessibilityRole="button"
                  accessibilityLabel="Set Final Exam Date"
                >
                  <Text style={styles.timeBtnText}>
                    {finalDate
              ...
              <View style={{ flex: 1, marginLeft: 8 }}>
                ...
                <TouchableOpacity
                  ...
                  accessible={true}
                  accessibilityRole="button"
                  accessibilityLabel="Set Final Exam Time"
                >
                  <Text style={styles.timeBtnText}>
                    {finalDate
            ...
            <TextInput
              ...
              placeholder="e.g. 402"
              accessible={true}
              accessibilityLabel="Final Exam Room Number"
            />
