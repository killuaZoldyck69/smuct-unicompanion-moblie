  ...
  const renderPostCard = ({ item }: { item: any }) => {
    ...
    return (
      <TouchableOpacity
        ...
        accessibilityLabel={`Forum post by ${item.author?.name || "Anonymous"}: ${item.title}. ${isResolved ? "Resolved." : "Needs help."} ${replyCount} replies.`}
      >
        ...
        >
          {[
            ...
            <TouchableOpacity
              ...
              accessibilityLabel={`${filter.label} filter tab`}
            >
              <Text
                style={[
                  styles.tabText,
          ...
          >
            <View style={styles.modalHeader}>
              <TouchableOpacity
                ...
                accessible={true}
                accessibilityRole="button"
                accessibilityLabel="Close create question modal"
              >
